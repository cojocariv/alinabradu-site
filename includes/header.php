...
<head>
  ...
  <link rel="stylesheet" href="<?= e(url('/assets/css/custom.css')) ?>?v=25">
  <script>document.documentElement.classList.add('js');</script>
  <script type="application/ld+json"><?= json_encode($orgSchema, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?></script>
</head>
<body class="bg-cream text-ink font-sans antialiased<?= $bodyClass !== '' ? ' ' . e($bodyClass) : '' ?>" data-chat-track-url="<?= e(url('/api/chat-contact')) ?>">
  <header class="site-header <?= $headerOverlay ? 'site-header--overlay' : 'site-header--solid' ?>">
    <div class="max-w-7xl mx-auto px-4 md:px-6 py-3.5 flex items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2 md:gap-5">
        ...
        <div class="header-social hidden sm:flex items-end gap-0.5 md:border-l md:pl-4 md:ml-1" role="group" aria-label="Rețele sociale">
          <a href="https://www.facebook.com/AlinaBraduEmbroidery" target="_blank" rel="noopener noreferrer" class="header-social__btn" aria-label="Facebook">
            <svg class="header-social__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            <span class="header-social__label" aria-hidden="true">Facebook</span>
          </a>
          <a href="https://www.instagram.com/alinabradu.brand" target="_blank" rel="noopener noreferrer" class="header-social__btn" aria-label="Instagram">
            ...
            <span class="header-social__label" aria-hidden="true">Instagram</span>
          </a>
          <a href="https://www.pinterest.com/AlinaBraduEmbroidery/" target="_blank" rel="noopener noreferrer" class="header-social__btn" aria-label="Pinterest">
            <svg class="header-social__icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 0C5.373 0 0 5.372 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.403.042-3.441.219-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.097.118.112.222.083.343-.09.375-.293 1.199-.334 1.363-.053.225-.172.271-.402.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.92-7.252 4.158 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.357-.629-2.748-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0z"/></svg>
            <span class="header-social__label" aria-hidden="true">Pinterest</span>
          </a>
          <a href="https://api.whatsapp.com/send?phone=37368693056" data-whatsapp-popup="1" data-chat-source="header" target="_blank" rel="noopener noreferrer" class="header-social__btn" aria-label="WhatsApp">
            ...
            <span class="header-social__label" aria-hidden="true">WhatsApp</span>
          </a>
        </div>
    ...
    <div id="site-mobile-nav" data-mobile-menu class="site-header__drawer hidden md:hidden">
      ...
      <div class="max-w-7xl mx-auto px-5 pb-5 flex items-end gap-2 border-t border-white/10 pt-4" role="group" aria-label="Rețele sociale">
        <a href="https://www.facebook.com/AlinaBraduEmbroidery" target="_blank" rel="noopener noreferrer" class="header-social__btn header-social__btn--drawer" aria-label="Facebook"><svg class="header-social__icon header-social__icon--drawer" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg><span class="header-social__label" aria-hidden="true">Facebook</span></a>
        <a href="https://www.instagram.com/alinabradu.brand" target="_blank" rel="noopener noreferrer" class="header-social__btn header-social__btn--drawer" aria-label="Instagram"><svg class="header-social__icon header-social__icon--drawer" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg><span class="header-social__label" aria-hidden="true">Instagram</span></a>
        <a href="https://www.pinterest.com/AlinaBraduEmbroidery/" target="_blank" rel="noopener noreferrer" class="header-social__btn header-social__btn--drawer" aria-label="Pinterest"><svg class="header-social__icon header-social__icon--drawer" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 0C5.373 0 0 5.372 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.403.042-3.441.219-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.097.118.112.222.083.343-.09.375-.293 1.199-.334 1.363-.053.225-.172.271-.402.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.92-7.252 4.158 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.357-.629-2.748-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0z"/></svg><span class="header-social__label" aria-hidden="true">Pinterest</span></a>
        <a href="https://api.whatsapp.com/send?phone=37368693056" data-whatsapp-popup="1" data-chat-source="header" target="_blank" rel="noopener noreferrer" class="header-social__btn header-social__btn--drawer" aria-label="WhatsApp"><svg class="header-social__icon header-social__icon--drawer" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.435 9.884-9.881 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg><span class="header-social__label" aria-hidden="true">WhatsApp</span></a>
      </div>
    </div>
  </header>
