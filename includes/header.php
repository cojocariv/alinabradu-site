    ...
    <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center gap-4 md:gap-6">
        ...
        <div class="header-social flex items-center gap-0.5 sm:gap-1 md:border-l md:pl-5 md:ml-1 <?= $headerOverlay ? 'md:border-white/25 text-white/90' : 'md:border-zinc-600 text-zinc-200' ?>" role="group" aria-label="Rețele sociale">
          ...
          <a href="https://www.instagram.com/alinabradu" target="_blank" rel="noopener noreferrer" class="p-2 rounded-full transition-colors hover:text-gold hover:bg-white/10" aria-label="Alina Bradu pe Instagram">
