...
<?php else: ?>
  ...
  <p class="text-xs text-ink-muted mt-2 max-w-md leading-relaxed">La click se deschide aplicația de chat. Cu cookie-urile funcționale acceptate, putem înregistra canalul și pagina — detalii în <a href="<?= e(url('/politica-confidentialitate')) ?>" class="text-gold hover:underline">Politica de confidențialitate</a>.</p>
<?php endif; ?>
