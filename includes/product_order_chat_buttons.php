...
<?php else: ?>
  ...
  <p class="text-xs text-ink-muted mt-2 max-w-md leading-relaxed">Deschiderea chat-ului poate implica prelucrarea datelor de către Meta (WhatsApp) sau Rakuten (Viber). Cu cookie-urile funcționale acceptate, înregistrăm canalul și pagina vizitată — vezi <a href="<?= e(url('/politica-confidentialitate')) ?>" class="text-gold hover:underline">Politica de confidențialitate</a> (<?= e(PRIVACY_LAW_SHORT) ?>).</p>
<?php endif; ?>
