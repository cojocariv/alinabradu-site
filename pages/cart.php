...
$seo = ['title' => 'Coș - Alina Bradu'];
require __DIR__ . '/../includes/header.php';
?>
<section class="max-w-5xl mx-auto px-4 py-10">
  <h1 class="font-serif text-4xl mb-6">Coșul tău</h1>
  <?php if (!$cart): ?>
    <p>Coșul este gol. <a href="<?= e(url('/magazin')) ?>" class="underline">Continuă cumpărăturile</a></p>
  <?php else: ?>
    <form method="post">
      <div class="space-y-4">
        <?php foreach ($cart as $key => $item): ?>
          <div class="bg-white rounded p-4 flex gap-4 items-center">
            ...
            <div class="flex-1">
              <p class="product-name text-lg"><?= e($item['name']) ?></p>
            ...
            <button name="remove" value="<?= e($key) ?>" class="text-red-600">Șterge</button>
          </div>
        <?php endforeach; ?>
      </div>
      <div class="mt-6 flex justify-between items-center">
        ...
        <div class="flex gap-3">
          <button class="px-4 py-2 border rounded">Actualizează</button>
